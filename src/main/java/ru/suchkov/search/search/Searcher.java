...
/**
 * По-хорошему искать надо по-другому.
 * Создать классы термов, строить дерево запроса и обрабатывать,
 * а не частные случаи рассматривать and, or, not.
 * Но времени не так много на такое большое задание, еще работа,
 * так что пока так. Может исправлю и дополню к 31
 */
